...
export const SET_ABOUT_TOPIC = 'SET_ABOUT_TOPIC';
export const SET_SHOW_ABOUT_PAGE = 'SET_SHOW_ABOUT_PAGE';
...
export const SET_SHOW_PROJECT_TEXT = 'SET_SHOW_PROJECT_TEXT';
